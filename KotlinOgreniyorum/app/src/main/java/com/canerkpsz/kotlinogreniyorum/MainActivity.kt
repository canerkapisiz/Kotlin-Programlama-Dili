package com.canerkpsz.kotlinogreniyorum
...
//Diziler - Array
        ...
        val stringOrnegi = "caner"

        val benimDizim = arrayOf(stringOrnegi, "kapısız", "zeynep", "fatih", "osman")
...
//println(benimDizim[5])
        ...
        val karisikDizi = arrayOf(10, 3.14, 20, "caner", false, true)
        println(karisikDizi[2])

        println("-------ArrayList-------")

        val isimListesi = arrayListOf("caner", "kapısız", "zeynep")
...
//isimListesi.removeAt(3)
        ...
        val karisikListe = arrayListOf(10, 3.14, "caner", true)
        val karisikBosListe = arrayListOf<Any>()
        karisikBosListe.add(10)
        karisikBosListe.add("caner")
...
// Anahtar - Değer Eşleşmesi
        ...
        ornekHashMap.put("caner", "kapısız")
